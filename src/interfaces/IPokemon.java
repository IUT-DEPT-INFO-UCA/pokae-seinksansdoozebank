...
public interface IPokemon {
	 ...
	 * @return Un int représentant le pourcentage de point de vie restant du pokemon.
	 */
	...
	/**Défini le tableaux des attaques que le pokemon pourra utiliser à partir d'un tableau de capacités.
	 ...
	 * @param atk Une Capacite repésentant la capacité utilisée par le pokemon attaquant.
	 */
	 ...
	 * @return Un booléen représentant l'état évanoui du pokemon, true s'il l'est, false sinon.
	 */
	public boolean estEvanoui();

	/**Récupère un booléen indiquant si le pokemon vient de changer de niveau.
	 * @return Un booléen valant true si le pokémon vient de changer de niveau, false sinon.
	 */
	...
	/**Soigne un pokemon en remettant ces PV à leur maximum et les PP de chacun de ses attaques à leur maximum.
	 */
